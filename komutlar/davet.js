...
exports.run = (client, message) => {
  const motionEmbed = new Discord.MessageEmbed()
    ...
    .setDescription(
      `Botta Toplamda **${client.commands.size}** Adet Komut Bulunuyor!` +
      `
`)
    .addField(
      ` :boom: Bilgilendirme`,
...
:white_small_square: | **Botu Ekleyerek Bize Destek Çıkmış Olursunuz.** `
  ...
  .addField(
      `**:boom:➤ Bağlantı **`,
      `>  » [Bot Davet Linki](https://discord.com/oauth2/authorize?client_id=843102227408224358&scope=bot&permissions=27648860222)  `
    )
    .setFooter(
      `
